...
<div style="width: 100%; padding: 8px; font-family: Arial, sans-serif; background-color: white;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        <nav style="font-size: 14px;">
            ...
            <span style="font-weight: bold; color:#023E8A;">Vehicle Inspection</span>
        </nav>
    </div>
    ...
    <!-- Search Bar -->
    <form method="GET" action="{{ route('vehicle.inspection.index') }}" id="searchForm" style="margin-bottom: 15px; display: flex; gap: 10px; align-items: center;">
