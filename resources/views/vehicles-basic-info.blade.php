...
@section('content')
<div style="width: 100%; padding: 20px; font-family: Arial, sans-serif; background-color: #FFFFFF;">

    <!-- Page Header -->
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
        <h5 style="font-weight: bold; margin: 0; color: #03045E;">Vehicle Management</h5>
        <nav style="font-size: 14px;">
            <a href="{{ route('home') }}" style="text-decoration: none; color: #0077B6;">Home</a> /
            <span style="font-weight: bold; color: #023E8A;">Vehicle Management</span>
        </nav>
    </div>
            ...
            <div style="display: flex; flex-direction: column; gap: 1rem; align-items: center;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 15px; justify-content: center; width: 100%; max-width: 900px;">
                    <div style="flex: 1; min-width: 220px;">
                        ...
                        <input type="text" id="service_date" name="service_date" readonly style="width: 880px; padding: 8px; border: 1px solid #90E0EF; border-radius: 5px; color: #03045E; background-color: #f3f4f6;">
                    </div>
                    <div style="flex: 1; min-width: 220px;">
                        <label for="next_service_date" style="display: block; font-size: 14px; margin-bottom: 4px; color: #023E8A;">Next Service Date</label>
                        <input type="text" id="next_service_date" name="next_service_date" readonly style="width: 880px; padding: 8px; border: 1px solid #90E0EF; border-radius: 5px; color: #03045E; background-color: #f3f4f6;">
                    </div>
                    <div style="flex: 1; min-width: 220px;">
