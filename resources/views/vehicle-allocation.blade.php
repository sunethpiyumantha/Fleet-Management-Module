...
@section('title', 'Vehicle Allocation Management')
...
<div style="max-width: 64rem; margin: 0 auto; padding: 2.5rem 1.5rem;">
  <div style="background-color: white; border: 1px solid #f97316; border-radius: 1rem; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05); padding: 1.5rem;">
    ...
    <form class="mb-8" style="margin-bottom: 2rem;">
      <div style="display: flex; flex-wrap: wrap; gap: 1rem; justify-content: space-between;">
        <div style="flex: 1; min-width: 250px;">
          <label for="allocationType" style="display: block; margin-bottom: 0.25rem; font-size: 0.875rem; font-weight: 500;">Vehicle Allocation Type</label>
          <input type="text" id="allocationType" name="allocation_type" required
        ...
        <div style="flex: 1; min-width: 250px;">
          ...
          <input type="text" id="vehicleCategory" name="vehicle_category" required
            style="width: 100%; border-radius: 0.5rem; border: 1px solid #d1d5db; color: #374151; padding: 0.5rem 0.75rem; outline: none;">
        </div>
        <div style="align-self: flex-end; min-width: 120px;">
          <button type="submit"
            style="width: 100%; background-color: #f97316; color: white; font-weight: 600; padding: 0.5rem 1rem; border-radius: 0.5rem; border: none; cursor: pointer;"
    ...
    <div style="margin-bottom: 1rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
      <input type="text" id="searchInput" placeholder="Search Allocation Type..."
        style="border: 1px solid #d1d5db; border-radius: 0.375rem; padding: 0.5rem 0.75rem; width: 100%; max-width: 300px;">
      <button type="button"
    ...
    <div style="overflow-x: auto;">
      <table id="vehicleTable"
        ...
        <thead style="background-color: #f97316; color: white;">
          <tr>
            <th style="padding: 0.75rem;" onclick="sortTable(0)">Vehicle Allocation Type &#x25B2;&#x25BC;</th>
            <th style="padding: 0.75rem;" onclick="sortTable(1)">Vehicle Category &#x25B2;&#x25BC;</th>
            <th style="padding: 0.75rem; text-align: center;">Actions</th>
          </tr>
        </thead>
        <tbody id="tableBody">
          @foreach ([['Admin Duties', 'Light Vehicle'], ['Staff Car', 'Motor Vehicle'], ['Medical Transport', 'Ambulance']] as $row)
            <tr>
              <td style="padding: 0.75rem; border-bottom: 1px solid #f3f4f6;">{{ $row[0] }}</td>
              <td style="padding: 0.75rem; border-bottom: 1px solid #f3f4f6;">{{ $row[1] }}</td>
