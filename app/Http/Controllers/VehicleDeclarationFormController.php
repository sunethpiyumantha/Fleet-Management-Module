...
use App\Models\VehicleEngineCapacity; // Updated to correct model
use App\Models\VehicleColor; // Updated to match database table
...
{
    /**
     * Show the vehicle declaration form.
     */
    ...
    /**
     * Store the vehicle declaration form data.
     */
    public function store(Request $request)
    {
        // Validate the form data
        $validated = $request->validate([
            'serial_number' => 'required|string|exists:vehicle_requests,serial_number', // Ensure serial_number exists
        ...
        // Create the vehicle declaration
