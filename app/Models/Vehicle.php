...
class Vehicle extends Model
{
    ...
    public function vehicleAllocationType()
    {
        return $this->belongsTo(VehicleAllocationType::class, 'vehicle_allocation_type_id');
    }
    ...
    public function frontTireSize()
    {
        return $this->belongsTo(VehicleTireSize::class, 'front_tire_size_id');
    }

    public function rearTireSize()
    {
        return $this->belongsTo(VehicleTireSize::class, 'rear_tire_size_id');
    }
    ...
    {
        return $this->belongsTo(Workshop::class, 'admitted_workshop_id');
    }
